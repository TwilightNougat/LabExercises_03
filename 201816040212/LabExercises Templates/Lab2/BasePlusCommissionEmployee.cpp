...
BasePlusCommissionEmployee::BasePlusCommissionEmployee( 
   ...
   :iii(first,last,ssn,sales,rate) /* Initialize the commissionEmployee data member,
   ...
   const string &ssn )
{
   /* Call commissionEmployee's setSocialSecurity function */
    iii.setSocialSecurityNumber(ssn);
...
string BasePlusCommissionEmployee::getSocialSecurityNumber() const
{
   /* Call commissionEmployee's getSocialSecurity function */
    return iii.getSocialSecurityNumber();
...
{
   return getBaseSalary() +iii.earnings()
